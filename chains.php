			...
			<div class="row">
				<div class="col-md-4">
					<div class="room-wrap ftco-animate">
						<a href="register.html" class="img" style="background-image: url(images/room-1.jpg);"></a>
						<div class="text pt-4 pl-lg-5">
							<h2><a href="register.html">Arlo NoMad</a></h2>
							<p class="rate">
							...
							<p><a href="register.html" class="btn-customize">View Hotels</a></p>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="room-wrap ftco-animate">
						<a href="register.html" class="img" style="background-image: url(images/room-2.jpg);"></a>
						<div class="text pt-4 pl-lg-5">
							<h2><a href="register.html">Marriot</a></h2>
							<p class="rate">
								<span class="icon-star"></span>
								<span class="icon-star"></span>
								<span class="icon-star"></span>
				...
				<div class="col-md-4">
					<div class="room-wrap ftco-animate">
						<a href="register.html" class="img" style="background-image: url(images/room-3.jpg);"></a>
						<div class="text pt-4 pl-lg-5">
							<h2><a href="register.html">Best Wsetin</a></h2>
							<p class="rate">
								<span class="icon-star"></span>
								<span class="icon-star"></span>
								<span class="icon-star"></span>
			...
			<div class="row mb-5 d-flex">
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<p style="color:white;font-size:20px;font-weight:bold;">We provide a place for the homeless
							people to live in
							during these tough
							times at free of
							cost. Don't worry we're together in this.</p>
					</div>
				</div>
			</div>
		</div>
