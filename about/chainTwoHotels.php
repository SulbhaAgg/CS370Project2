...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	...
	<section class="home-slider js-fullheight owl-carousel">
		<div class="slider-item js-fullheight" style="background-image:url(images/Hotel2.jpg);">
			...
			<div class="row justify-content-md-center">
				<div class="col-md-4">
					<div class="room-wrap ftco-animate">
						<a href="register.html" class="img" style="background-image: url(images/chain2hotel1.jpg);"></a>
						<div class="text pt-4 pl-lg-5">
							<h2><a href="register.html">Location: 2, 5</a></h2>
							<p class="rate">
				...
				<div class="col-md-4">
					<div class="room-wrap ftco-animate">
						<a href="register.html" class="img" style="background-image: url(images/chain2hotel2.jpg);"></a>
						<div class="text pt-4 pl-lg-5">
							<h2><a href="register.html">Location: 7, 11</a></h2>
							<p class="rate">
								<span class="icon-star"></span>
								<span class="icon-star"></span>
								<span class="icon-star"></span>
							...
							<p class="d-flex price-details align-items-center pt-3">
								<span>Luxury Rooms: 200</span>
								<span class="price">&nbsp;$725</span>
							</p>
							<p class="d-flex price-details align-items-center pt-3">
								<span>Standard&nbsp;Rooms:&nbsp;124</span>
